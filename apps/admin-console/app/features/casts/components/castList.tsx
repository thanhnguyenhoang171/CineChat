  ...
  return (
    <div className='flex flex-col h-full w-full justify-center'>
              ...
              castsList.map((cast) => (
                <TableRow
                  ...
                  <TableCell className='px-4 py-3'>
                    <Badge
                      variant='outline'
                      className='text-[10px] font-black border-primary/20 text-primary/70 bg-primary/5'>
                      {cast.role}
                    </Badge>
                  </TableCell>
                  ...
                  <TableCell className='px-4 py-3'>
                    <div className='flex items-center justify-center gap-1'>
                      <AppModifyButton
                        handleOnClick={() => handleEditClick(cast)}
                      />
                      <AppDeleteButton
                        handleOnClick={() => handleDeleteClick(cast)}
                      />
                    </div>
                  </TableCell>
                </TableRow>
      ...
      <AppAlertDialog
        ...
        description={t('cast:deleteDialog.description', {
          name: castToDelete?.name,
        })}
