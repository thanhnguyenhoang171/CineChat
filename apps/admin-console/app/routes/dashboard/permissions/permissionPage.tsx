...
export default function PermissionPage() {
  ...
  const handleApplyFilters = (filters: {
    ...
    setSearchParams((prev) => {
      // Handle Filtering
      if (filters.method) prev.set('method', filters.method);
      else prev.delete('method');
      if (filters.module) prev.set('module', filters.module);
      else prev.delete('module');
      if (filters.isActive !== 'all') prev.set('isActive', filters.isActive);
