...
import { BusinessCode } from 'src/types/http-status/business-code';
import { ResponseMessage } from 'src/types/http-status/response-message';
import { RESPONSE_STATUS } from 'src/decorators/response_message.decorator';
  ...
  implements NestInterceptor<T, ApiResponse<T>>
{
  ...
  intercept(context: ExecutionContext, next: CallHandler): Observable<any> {
    const httpCode =
      this.reflector.get<HttpStatusCode>(
        RESPONSE_STATUS,
        context.getHandler(),
      ) || HttpStatusCode.OK;
