import { ArrowDown, ArrowUp, ArrowUpDown, TriangleAlert, Tag } from 'lucide-react';
  ...
  return (
    <div className='flex flex-col h-full w-full justify-center'>
          ...
          <TableBody>
            {isLoading ? (
              ...
              genresList.map((genre) => (
                <TableRow key={genre._id} className='hover:bg-muted/30 transition-colors'>
                  {/* Name */}
                  ...
                  <TableCell className='px-4 py-3'>
                    <div className='flex items-center justify-center gap-1'>
                      <AppModifyButton handleOnClick={() => handleEditClick(genre)} />
                      <AppDeleteButton handleOnClick={() => handleDeleteClick(genre)} />
                    </div>
                  </TableCell>
                </TableRow>
              ))
      ...
      <AppAlertDialog
        ...
        description={t('genre:deleteDialog.description', { name: genreToDelete?.name })}
